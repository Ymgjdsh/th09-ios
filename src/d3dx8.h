...
D3DXVECTOR4 *D3DXVec4Transform(D3DXVECTOR4 *, const D3DXVECTOR4 *, const D3DXMATRIX *);
...
HRESULT D3DXLoadSurfaceFromMemory(IDirect3DSurface8 *, const void *, const RECT *, LPCVOID, D3DFORMAT,
                                  UINT, const void *, const RECT *, DWORD, D3DCOLOR);
